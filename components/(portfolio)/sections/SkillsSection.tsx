      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="space-y-3">
                    {categorySkills.map((skill) => (
                      ...
                      >
                        ...
                        <span
                          className={`text-xs font-medium px-2.5 py-1 rounded-full ${levelColors[skill.level]}`}
                        >
                          {skill.level}
                        </span>
                      </div>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              'React Native', 'Vue.js', 'GraphQL', 'Redis', 'Socket.io',
              'Jest', 'Cypress', 'Figma', 'Adobe XD', 'Postman',

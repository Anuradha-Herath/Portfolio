              ...
              >
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`group relative w-14 h-14 rounded-2xl bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-slate-700/50 flex items-center justify-center text-slate-400 transition-all duration-500 shadow-lg hover:shadow-2xl backdrop-blur-sm overflow-hidden ${social.hoverColor}`}
                    whileHover={{
                      scale: 1.15,
                      y: -5,
                      rotateY: 15,
                  ...
                  >
                    ...
                    {/* Subtle glow effect */}
                    <motion.div
                      className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-30 blur-xl"
                      style={{
                    ...
                    <motion.div
                      className="absolute -top-16 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-slate-900/95 text-white text-sm rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none whitespace-nowrap backdrop-blur-sm border border-slate-700/50 shadow-xl"
